...
from app.models import (
    Network, Shipment, ShipmentStatus, ShipmentCollection,
    ...
    def test_data_integrity(self):
        ...
        if 'shipments' in self.test_data:
            ...
            if shipments_data:
                ...
                has_shipment_id = any(
                    key in first_shipment for key in ['shipment index', 'shipment_index', 'shipment number'])
                ...
                print(
                    f"货物数据字段检查: shipment_id={has_shipment_id}, origin={has_origin}, destination={has_destination}")
